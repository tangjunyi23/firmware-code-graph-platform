...
set -x
cd "${OWRT_DIR:-/home/tankuku/toolchains/owrt}"
...
cd "${FWGRAPH_ROOT:-/home/tankuku/firmware-graph/fwgraph}/libc-sigs"
LIBC_A="${LIBC_A:-/home/tankuku/toolchains/owrt/omap4/staging_dir/toolchain-arm_v7-a_gcc-4.6-linaro_uClibc-0.9.33.2_eabi/lib/libc.a}" \
