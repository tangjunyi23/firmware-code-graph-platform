...
> 会话 `s-mu5709v5-daf9` · 固件任务 `6df0ba4135c9` · 2026-09-17T07:23:50Z

## 一、任务信息

| 项 | 内容 |
| --- | --- |
| 任务目标 | 用 fw_get_identification 盘点当前固件的公网输入清单，再用 fw_attack_surface brief=true 取前10条路径做静态筛查，只做静态不要跑动态 |
| 引擎 | dsh（模式：dynamic） |
| 轮次 | 1 / 30 |
